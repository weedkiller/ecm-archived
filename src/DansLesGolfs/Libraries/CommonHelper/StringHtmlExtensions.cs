...
{
    /// <summary>
    /// Extenstion for HTML String
    /// Original: http://robvolk.com/truncate-html-string-c-extension-method/
    /// </summary>
    public static class StringHtmlExtensions
    {
        ...
        {
            if (string.IsNullOrEmpty(text) || maxCharacters <= 0 || text.Length <= (maxCharacters + trailingText.Length))
                return text;
            else
