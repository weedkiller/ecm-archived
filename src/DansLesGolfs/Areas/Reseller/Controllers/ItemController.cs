...
{
    public class ItemController : BaseResellerCRUDController
    {
        #region Constructor
        ...
        {
            List<Item> models = DataAccess.GetAllItems(param, ItemType.Type.Product, Auth.User.SiteId, this.CultureId);
            return models;
        }
