...
{
    public class GolfLessonController : BaseResellerCRUDController
    {
        #region Constructor
        public GolfLessonController()
        {
            ObjectName = "GolfLesson";
            TitleName = "Golf Lesson";
            PrimaryKey = "ItemId";
            IsClonable = true;
        ...
        {
            List<Item> models = DataAccess.GetAllItems(param, ItemType.Type.GolfLesson, Auth.User.SiteId, this.CultureId);
            return models;
        }

        protected override void DoPrepareForm(int? id = null)
        {
            List<ItemCategory> golfLessonTypes = DataAccess.GetItemCategoriesDropDownList((int)ItemType.Type.GolfLesson);
            ViewBag.GolfLessonTypes = ListToDropDownList<ItemCategory>(golfLessonTypes, "CategoryId", "CategoryName");
        ...
        {
            ViewBag.ItemCode = DataAccess.GetItemRunningNumber((int)ItemType.Type.GolfLesson, 6, DataManager.ToInt(ViewBag.CategoryId));
        ...
        protected override object DoPrepareNew()
        {
            return new Item()
            {
                ItemCode = DataAccess.GetItemRunningNumber((int)ItemType.Type.GolfLesson, 6),
                ItemTypeId = (int)ItemType.Type.GolfLesson,
                IsPublish = true,
                IsAllowReview = false,
        ...
        protected override bool DoSave()
        {
            ...
            model.IncludeAccommodation = DataManager.ToBoolean(Request.Form["IncludeAccommodation"]);
