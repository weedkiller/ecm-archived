...
{
    public class DrivingRangeController : BaseResellerCRUDController
    {
        #region Constructor
        public DrivingRangeController()
        {
            ObjectName = "DrivingRange";
            TitleName = "Driving Range";
            PrimaryKey = "ItemId";
            IsClonable = true;
        ...
        {
            List<Item> models = DataAccess.GetAllItems(param, ItemType.Type.DrivingRange, Auth.User.SiteId, this.CultureId);
            return models;
        }
        ...
        {
            ViewBag.ItemCode = DataAccess.GetItemRunningNumber((int)ItemType.Type.DrivingRange, 6, DataManager.ToInt(ViewBag.CategoryId));
        ...
        protected override object DoPrepareNew()
        {
            return new Item()
            {
                ItemCode = DataAccess.GetItemRunningNumber((int)ItemType.Type.DrivingRange, 6),
                ItemTypeId = (int)ItemType.Type.DrivingRange,
                IsPublish = true,
                IsAllowReview = false,
        ...
        protected override bool DoSave()
        {
            ...
            model.ItemId = id;
            model.ItemTypeId = (int)ItemType.Type.DrivingRange;
