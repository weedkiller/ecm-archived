...
{
    public class SaleItemsReportController : BaseResellerController
    {
        public ActionResult Index()
        {
            ...
            Breadcrumbs.Add(Resources.Resources.SaleDetail, "~/Reseller/SaleItemsReport");
            InitBreadcrumbs();
            ...
            foreach (SaleItemReport row in list)
            {
                ...
                for (int i = 0; i < columnLength; i++)
                {
                    ...
                    else if (props[i].Name == "OrderNumber" && orderId > 0)
                    {
                        ...
                        htmlArray.Add("<a href=\"" + Url.Content("~/Reseller/Orders/ViewOrderInvoice/" + orderId) + "\" target=\"_blank\">" + value + "</a>");
                    }
                    else
                    {
