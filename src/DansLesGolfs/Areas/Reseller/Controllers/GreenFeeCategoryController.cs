...
{
    public class GreenFeeCategoryController : BaseResellerCRUDController
    {
        #region Constructor
        public GreenFeeCategoryController()
        {
            ObjectName = "GreenFeeCategory";
            TitleName = "Green Fee Category";
        ...
        {
            List<ItemCategory> models = DataAccess.GetAllGreenFeeCategories(param, null);
            return models;
        }
