...
{
    public class DrivingRangeController : BaseAdminCRUDController
    {
        #region Constructor
        ...
        {
            List<Item> models = DataAccess.GetAllItems(param, ItemType.Type.DrivingRange, null, this.CultureId);
            return models;
        }
