...
{
    public class AdvertiseController : BaseAdminController
    {
        public ActionResult Manage()
        {
            ...
            Breadcrumbs.Add(Resources.Resources.AdsManager, "~/Admin/Advertise/Manage");
            InitBreadcrumbs();
        ...
        public ActionResult GetAdsInAdset(int? adsetId = null)
        {
            try
            {
                ...
                string html = RenderViewToString("~/Views/_Shared/UC/Admin/Ads/UCAdsList.cshtml", adsList);
                return Json(new
                {
                    isSuccess = true,
                    content = html
