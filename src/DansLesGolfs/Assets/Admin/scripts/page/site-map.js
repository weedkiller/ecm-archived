...
function addMarker(lat, lng) {
    ...
    jQuery('input[name="Latitude"]').val(lat.toLocaleString(window.locale, { minimumFractionDigits: 6 }));
    jQuery('input[name="Longitude"]').val(lng.toLocaleString(window.locale, { minimumFractionDigits: 6 }));
