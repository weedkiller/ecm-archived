...
$(function () {
    ...
    $('.view-report').click(function () {
        ...
        var url = GetUrl('Reseller/Reports/ViewReport?startdate=' + startdatetime + '&&enddate=' + enddatetime + '&&status=' + status);
    ...
    oOrderTable = $('#saleorder').dataTable({
        ...
        "bServerSide": true,
        "bJQueryUI": false,
        "sAjaxSource": GetUrl('Reseller/Reports/DoLoadDataJSON'),
...
function SaleReport() {
    ...
    t.changeStatus = function (id, isStatus, callback) {
        ...
        $.post('/Reseller/reports/DoUpdateOrderPaymentStatus', data, function (res) {
            console.log(res);
