...
function initDataTable() {
    ...
    window.dataTable = $('.dataTable').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": getUrl("Reseller/SaleItemsReport/AjaxLoadData"),
            "type": "post",
            "data": function (d) {
...
function onViewReportButtonIsClicked(e) {
    ...
    var popup = window.open(getUrl('Reseller/SaleItemsReport/ViewReport?fromDate=' + fromDate + '&toDate=' + toDate), 'saleitemsreport');
}