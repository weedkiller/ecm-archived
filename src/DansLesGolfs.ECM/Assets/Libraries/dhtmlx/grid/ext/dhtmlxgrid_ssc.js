...
dhtmlXGridObject.prototype.loadHiddenColumnsFromCookie=function(b){var a=this._getCookie(b,4),c=(a||"").split(",");if(!(c.length>this._cCount)&&a)for(var d=0;d<c.length;d++)this.setColumnHidden(d,c[d]?!0:!1)};dhtmlXGridObject.prototype.saveSortingToCookie=function(b,a){this.setCookie(b,a,2,(this.getSortingState()||[]).join(","))};
