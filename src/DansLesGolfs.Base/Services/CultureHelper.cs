...
namespace DansLesGolfs.Base
{
    public class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> { "fr-FR"
            , "en-US"
        };

        /// <summary>
        /// Change language by specific locale.
        /// </summary>
        /// <param name="locale">Locale that you want to change to.</param>
